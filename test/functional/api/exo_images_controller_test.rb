...
class Api::ExoImagesControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to api_exo_image_url(assigns(:exo_image))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to api_exo_images_url
